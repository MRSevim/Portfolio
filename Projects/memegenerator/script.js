...
function showMeme() {
  ...
  document.getElementById("memes").innerHTML=`<img src="${randomMemeUrl}">`;
...
function showJoke() {
  ...
  document.getElementById("funny").innerHTML=randomJokeText;
}
...
function showQuote() {
  ...
  document.getElementById("wisdom").innerHTML=randomQuote.quote;
...
function showRiddle() {
  ...
  document.getElementById("riddles").innerHTML=randomRiddle.question;
...
function revealAnswers() {
  if (document.getElementById('riddles').childNodes.length === 0) {alert ("There is no riddle")}
  else if (document.getElementById("answer").style.display === 'block') {alert("Answer is already revealed")}
  else {document.getElementById("answer").style.display = 'block'};
}
